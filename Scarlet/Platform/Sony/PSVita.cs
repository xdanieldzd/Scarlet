...
namespace Scarlet.Platform.Sony
{
    ...
    public static class PSVita
    {
        static readonly Dictionary<SceGxmTextureFormat, PixelDataFormat> formatMap = new Dictionary<SceGxmTextureFormat, PixelDataFormat>()
        {
            ...
            /* DXT1     */ { SceGxmTextureFormat.UBC1_ABGR, PixelDataFormat.FormatDXT1_Vita },
            /* DXT3     */ { SceGxmTextureFormat.UBC2_ABGR, PixelDataFormat.FormatDXT3_Vita },
            /* DXT5     */ { SceGxmTextureFormat.UBC3_ABGR, PixelDataFormat.FormatDXT5_Vita },
