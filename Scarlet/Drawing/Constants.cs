...
namespace Scarlet.Drawing
{
    ...
    public enum PixelDataFormat : ulong
    {
        ...
        /// </summary>
        ChannelsLuminanceAlpha = (1 << 14),

        /// <summary>
        /// Format is indexed color
        /// </summary>
        ChannelsIndexed = (1 << 15),
